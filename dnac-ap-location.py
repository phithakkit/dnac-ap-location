...
Examples:
    ...
    result_data = map_locations_from_csv(dnac, args.file)


def map_locations_from_csv(dnac, csv_file):
    '''
    Read CSV file with 'Device Name' column, get UUIDs from DNAC, and create updated CSV
    
    CSV Format:
    Device Name,<other columns>...
    '''
    results = []
